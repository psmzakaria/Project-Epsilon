Project Title:E-Waste-Y-Waste Web App
This app gives its user on details on how you can efficiently get rid of Electronic wastes in Singapore.
A map of where you can drop off the waste is created.
List of allowable E-Waste given in the dropbox.

GitHub link:https://github.com/psmzakaria/Project-Epsilon

Prerequisites:BootStrap and React.js
BootStrap setup:
